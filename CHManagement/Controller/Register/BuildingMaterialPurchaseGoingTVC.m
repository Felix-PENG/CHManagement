//
//  BuildingMaterialPurchaseGoingTVC.m
//  CHManagement
//
...
@implementation BuildingMaterialPurchaseGoingTVC
...
{
    [[NetworkManager sharedInstance] getBillMaterialsListWithGroupId:self.groupID withStatus:STATUS_NOT_FINISHED withIn_off:BILL_IN withPage:page completionHandler:^(NSDictionary *response) {
